(function () {
  ...
  var clickMenu = function () {
    $('#navbar a:not([class="external"]), a[data-nav-section]').click(function (
      event
    ) {
      var section = $(this).data("nav-section"),
        navbar = $("#navbar");
  ...
  $(function () {
    ...
    document.querySelectorAll(".animate-box").forEach((el) => {
      el.style.opacity = "0"; // optional if your CSS already does this
      el.style.visibility = "hidden"; // optional
      io.observe(el);
    });
